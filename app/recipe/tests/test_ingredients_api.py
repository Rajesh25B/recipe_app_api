...
class PublicIngredientsApiTests(TestCase):
    ...
    def test_required_login(self):
        '''Test that login is required to assess ingredients endpoint'''
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_create_ingredients_invalid(self):
        '''Test creating ingredients fails'''
        payload = {'name': ''}
    ...
    def test_retrieve_ingredients_assigned_to_recipe(self):
        ...
        # Serialize our ingredients and see if they are in response
